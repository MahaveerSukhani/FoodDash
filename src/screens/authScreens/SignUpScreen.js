...
export default function SignUpScreen({ navigation }) {
    ...
    async function signUp(values) {
        const { email, password, name, family_name, phone_number } = values;

        // Basic input validation
        if (!email || !password || !name || !family_name || !phone_number) {
            ...
            <ScrollView keyboardShouldPersistTaps="always">
                ...
                <Formik initialValues={initialValues} onSubmit={(values) => { signUp(values) }}>
                    {(props) => (
                        <View style={styles.view2}>
                            <View>
                                <Text style={styles.text2}>New on Home Cooked App ?</Text>
                            </View>
                ...
                <View style={styles.view19}>
                    <View style={styles.view20}>
                        <Text style={styles.text6}>Already have an account with Home Cooked Food ?</Text>
                    </View>
